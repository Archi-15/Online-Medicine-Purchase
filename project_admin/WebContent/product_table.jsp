...
<title>Product Master Table</title>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="user_table.jsp"><i class="fa fa-users"></i><span>Users</span></a></li>
		 ...
		 <div class="main-content main-content2 main-content2copy">
			...
			<div class="menu-right">
				<div class="user-panel-top">  	
					...
					<li class="dropdown">
								<a href="notification.jsp" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-bell"></i><span class="badge blue">3</span></a>
					</li>	
...
<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">Product Master Table</h3>
					 <div class="xs tabls" >
						<div class="bs-example4" data-example-id="contextual-table" style="width:auto;">
						<table class="table">
						  <thead>
							<tr>
							  <th>id</th>
						...
						<tr>
								...
								<td>
									<form name="edit" method="post" action="ProductController">
										<input type="hidden" name="id" value="<%=p.getPr_no()%>">
