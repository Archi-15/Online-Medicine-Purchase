						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="frm" method="post" action="ProductController">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="productname" placeholder="PRODUCT NAME" name="p_name">
									</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
									<textarea id="productdescription" cols="50" rows="4" class="form-control1" placeholder="PRODUCT DESCRIPTION" name="p_des"></textarea>
									</div>
								</div> 
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="product_price" placeholder="PRODUCT PRICE" name="p_price">
									</div>
								</div> 
								<div class="form-group">
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="product_quant" placeholder="PRODUCT QUANTITY" name="p_quant">
									</div>
								</div> 
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" class="form-control1" id="product_mfgdate" placeholder="PRODUCT MFG DATE(dd/mm/yyyy)" name="p_mfg">
									</div>
								</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" class="form-control1" id="product_expdate" placeholder="PRODUCT EXPIRY DATE(dd/mm/yyyy)" name="p_exp">
									</div>
								</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="product_mfgby" placeholder="COMPANY NAME" name="p_company">
									</div>
								</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="product_type" placeholder="PRODUCT TYPE" name="p_type">
									</div>
								</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="product_dose" placeholder="PRODUCT DOSAGE" name="p_dosage">
									</div>
								</div> 
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="product_drug" placeholder="PRODUCT DRUG" name="p_drug">
									</div>
								</div>
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="product_age" placeholder="PRODUCT USER AGE" name="age">
									</div>
								</div>
								
								<div class="form-group">
								<input type="submit" class="btn" name="action" value="Insert Product">
								</div>
									</form>
				</div>
