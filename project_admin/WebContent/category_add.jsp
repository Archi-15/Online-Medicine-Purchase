...
.btn:hover {
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
	...
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<div class="add-form" style="background-color:#fff;width:90%;height:500px;padding:20px;margin-left:55px; webkit-box-shadow:2px 1px 4px rgba(0,0,0,0.5);-moz-box-shadow:2px 1px 4px rgba(0,0,0,0.5);">
					<h3 class="blank1">Add Category</h3>
						<div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="frm" method="post" action="ProductController">
								<div class="form-group">
									<label for="productname" class="col-sm-2 control-label">Category:</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="productname" name="cat_name" placeholder="PRODUCT NAME">
									</div>
								</div>
								<div class="form-group">
								<input type="submit" class="btn" name="action" value="Insert Category">
								</div>
							</form>
						 </div>
						 </div>
