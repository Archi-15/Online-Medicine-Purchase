...
String ucontact=request.getAttribute("ucontact").toString();
String txtamt=request.getAttribute("txtamt").toString();

String merchantMid = "bUlPIf52385395577074";
//Key in your staging and production MID available in your dashboard
String merchantKey = "4Afn2bFrXEjdizJt";
//Key in your staging and production merchant key available in your dashboard
String orderId = "order1"+r1;
String channelId = "WEB";
String custId =uid;   /* "cust123"; */
String mobileNo = ucontact;  /* "9512085687"; */
String email = "pratikmedicalstore16@gmail.com";
String txnAmount = txtamt;/*  "100.12"; */
String website = "WEBSTAGING";
//This is the staging value. Production value is available in your dashboard
String industryTypeId = "Retail";
//This is the staging value. Production value is available in your dashboard
String callbackUrl = "http://localhost:8080/project_user/pgResponse.jsp";
