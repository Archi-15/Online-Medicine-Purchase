...
<%-- <%
	...
	if(session!=null)
	{
		...
		{
			System.out.println("in session user login if");
...
<header>
	...
	<!-- <div style="text-align:center; background-color:white; margin-left:-100px;"> -->
			<form class="contact100-form validate-form" name="Login user" method="post" action="UserActionController">
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<input id="email" class="input100" type="text" name="lemail" placeholder="Eg. example@email.com">
					<span class="focus-input100"></span>
				</div>

				

				<label class="label-input100" for="pass">Password</label>
				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					<input type="password" id="pass1" class="input100" name="lpass" placeholder="Enter Your Password">
					<span class="focus-input100"></span>
				</div>


				<div class="container-contact100-form-btn">
					<button class="contact100-form-btn" style="background-color:#F8694A; font-size:15px;" name="action" value="user-login">
						<b>Login</b>
					</button>
				</div>
			</form>
			
			<div class="contact100-more" style="background-image: url('images/reg1.jpg');">
			</div>
		</div>
	</div>
...
<%
		...
		{
			System.out.println("in session user login else inm");
			response.sendRedirect("user_login.jsp");
		}
	}
	else
	{
		System.out.println("in session user login else");
		response.sendRedirect("user_login.jsp");
	}
