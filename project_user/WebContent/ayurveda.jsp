...
<head>
	...
	<!-- Slick -->
	<link type="text/css" rel="stylesheest" href="css/slick.css" />
...
<% 
	...
	if(session.getAttribute("u")!=null)
	{
		...
		System.out.println("bg:"+u.getUid());
...
%>
			...
			<!-- category nav -->
				<div class="category-nav show-on-click">
					...
					<ul class="category-list">
						...
						<li><a href="diabetic_care.jsp">Diabetes Care</a></li>
						<li><a href="child_care.jsp">Child Care</a></li>
						<li><a href="skin_hair_care.jsp">Skin and Hair Care</a></li>
						<li><a href="elderley_care.jsp">Elderly Care</a></li>
						<li><a href="oral_care.jsp">Oral Care</a></li>
						<li><a href="daily_living_aid_product.jsp">Daily living aids</a></li>
					</ul>
				</div>
				<!-- /category nav -->
				<!-- menu nav -->
				<div class="menu-nav">
					...
					<ul class="menu-list">
						<li><a href="new_index.jsp">Home</a></li>
 ...
 <!----------------------- MAIN CATEGORY PAGE-------------------------------------------------------->
				...
				<div id="main" class="col-md-9"  style="width:100%;">
					<p style="font-family:'Hind', sans-serif;color:black;font-size:40px;"><b>AYURVEDA PRODUCTS</b></p>
					<!-- STORE -->
					<div id="store1"  style="width:100%;">
						...
						<div class="row">
						  	<%
								for(Product p:list)
								{
									int id= p.getCat().getCat_id();	
									System.out.println("cat_id"+id);		
									if(id==2)
									{
							...
							<div class="col-md-4 col-sm-6 col-xs-6" style="width:280px;">
								<div class="product product-single" style="width:260px;position:relative;">
									...
									<div class="product-thumb1">
										<input type="hidden" name="p_id" value="<%=p.getPr_no()%>">
										 <input type="hidden" name="uid"  value="<%=u.getUid()%>">   
										 <input type="hidden" name="amount" value="<%=p. getPrice()%>">
										<button class="main-btn quick-view" name="action" value="Quick view"><i class="fa fa-search-plus"></i> Quick view</button>
										<img src="product/<%=p.getP_image()%>" alt="abc" style="max-width:100%;height:240px;"> 
									</div>
									<div class="product-body1">
										<label class="product-name"><a href="#" style="font-size:20px;"><%=p.getP_name()%></a></label><br>
										<label class="product-name"><%=p.getP_des()%></label><br>
										<label class="product-price" style="font-size:17px;"><%=p.getPrice()%></label>
											<div class="product-btns">
											
											<button class="primary-btn add-to-cart" name="action" value="Add to Cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
																					</div>
									</div>
									</form>
								</div>
...
<!---------------------------------------------------- MAIN CATEGORY PAGE-------------------------------------------------------->
	...
	{
			System.out.println("in  else session");
			request.getRequestDispatcher("ayurveda.jsp");
