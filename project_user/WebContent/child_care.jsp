...
%>
 ...
 <!----------------------- MAIN CATEGORY PAGE-------------------------------------------------------->
				...
				<div id="main" class="col-md-9"  style="width:100%;">
					<p style="font-family:'Hind', sans-serif;color:black;font-size:40px;"><b>CHILD CARE PRODUCTS</b></p>
					<!-- STORE -->
	...
	<!-------------------------------------------- 1  ROW ------------------------------------------------------------->
							...
							<div class="col-md-4 col-sm-6 col-xs-6" style="width:280px;">
								<div class="product product-single" style="width:260px;position:relative;">
									<div class="product-thumb1">
										...
										<!-- <img src="./img/childCare/img11.jpg" alt="" style="max-width:100%;height:240px;">  -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">Himalaya Baby Powder</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50</h3>
							...
							<div class="col-md-4 col-sm-6 col-xs-6"style="width:280px;margin-left:30px;">
								<div class="product product-single">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img2.jpg" alt=""style="max-width:100%;height:240px;"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">Johnson's Baby Shampoo</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50</h3>
							...
							<div class="col-md-4 col-sm-6 col-xs-6" style="width:280px;margin-left:30px;">
								<div class="product product-single">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img3.jpg" alt=""style="max-width:100%;height:240px;"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">Johnson's Baby Hair Oil</a></h2>
							...
							<div class="col-md-4 col-sm-6 col-xs-6"style="width:280px;margin-left:30px;">
								<div class="product product-single">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img4.jpg" alt="" style="max-width:100%;height:240px;"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">Himalaya Baby Pants</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50<br>strip of 15 tablets</h3>
...
<!-------------------------------------------- 2  ROW --------------------------------------------------------------------------->							
							...
							<div class="col-md-4 col-sm-6 col-xs-6" style="width:280px;">
								<div class="product product-single" style="width:260px;position:relative;">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img5.jpg" alt="" height="100%" width="100%"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">Johnson's Baby Soap</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50<br>strip of 15 tablets</h3>
											<div class="product-btns">
												<button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>	</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-6"style="width:280px;margin-left:30px;">
								<div class="product product-single">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img6.jpg" alt="" height="100%" width="100%"> -->
									</div>
									<div class="product-body1">
							...
							<div class="col-md-4 col-sm-6 col-xs-6" style="width:280px;margin-left:30px;">
								<div class="product product-single">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img7.jpg" alt="" height="100%" width="100%"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">CROCIN</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50<br>strip of 15 tablets</h3>
							...
							<div class="col-md-4 col-sm-6 col-xs-6"style="width:280px;margin-left:30px;">
								<div class="product product-single">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img8.jpg" alt="" height="100%" width="100%"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">CROCIN</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50<br>strip of 15 tablets</h3>
...
<!-------------------------------------------- 3  ROW --------------------------------------------------------------------------->							
							...
							<div class="col-md-4 col-sm-6 col-xs-6" style="width:280px;">
								<div class="product product-single" style="width:260px;position:relative;">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img9.jpg" alt="" height="100%" width="100%"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">CROCIN</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50<br>strip of 15 tablets</h3>
							...
							<div class="col-md-4 col-sm-6 col-xs-6"style="width:280px;margin-left:30px;">
								<div class="product product-single">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img10.jpg" alt="" height="100%" width="100%"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">CROCIN</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50<br>strip of 15 tablets</h3>
							...
							<div class="col-md-4 col-sm-6 col-xs-6" style="width:280px;margin-left:30px;">
								<div class="product product-single">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img12.jpg" alt="" height="100%" width="100%"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">CROCIN</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50<br>strip of 15 tablets</h3>
							...
							<div class="col-md-4 col-sm-6 col-xs-6"style="width:280px;margin-left:30px;">
								<div class="product product-single">
									<div class="product-thumb1">
										<button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
										<!-- <img src="./img/childCare/img13.jpg" alt="" height="100%" width="100%"> -->
									</div>
									<div class="product-body1">
										<h2 class="product-name"><a href="#" style="font-size:20px;">CROCIN</a></h2>
										<h3 class="product-price" style="font-size:17px;">$32.50<br>strip of 15 tablets</h3>
